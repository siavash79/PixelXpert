...
public class HotSpotController extends XposedModPack {
	...
	public void updatePrefs(String... Key) {
		...
		try
		{
			timeout = (long) (RangeSliderPreference.getValues(Xprefs, "hotSpotTimeoutSecs", 0).get(0) * 1000L);
		}
		...
		try
		{
			clients = round(RangeSliderPreference.getValues(Xprefs, "hotSpotMaxClients", 0).get(0));
		}
		catch (Throwable ignored){}
