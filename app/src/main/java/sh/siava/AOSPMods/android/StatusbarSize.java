...
public class StatusbarSize extends XposedModPack
{
	...
	public void updatePrefs(String... Key)
	{
		...
		if(sizeFactor != 100)
			currentHeight = Math.round(mContext.getResources()
			                                   .getDimensionPixelSize(mContext.getResources()
			                                                                  .getIdentifier("status_bar_height", "dimen", "android")) * sizeFactor / 100f);
	}
