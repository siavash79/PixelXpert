...
public class CustomNavGestures extends XposedModPack {
	...
	private static float mSwipeUpPercentage = 0.2f;
	...
	public void updatePrefs(String... Key) {
		...
		mSwipeUpPercentage = readRangeSlider(Xprefs, "mSwipeUpPercentage", 20f)/100f;
	}
	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
		...
		Class<?> TaskbarStashInputConsumerClass = findClass("com.android.quickstep.inputconsumers.TaskbarStashInputConsumer", lpparam.classLoader); //When using Taskbar
		...
		XC_MethodHook navGestureHook = new XC_MethodHook() {
			...
			protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
				...
				{
					mSwipeUpThreshold = e.getY() * (1f - mSwipeUpPercentage);
		...
		hookAllMethods(TaskbarStashInputConsumerClass, "onMotionEvent", navGestureHook);
	}
