...
public class AOSPSettingsLauncher extends XposedModPack
{
	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable
	{
		...
		View.OnLongClickListener listener = v -> {
			try {
				Intent launchInent = mContext.getPackageManager()
				                             .getLaunchIntentForPackage("sh.siava.AOSPMods");
		...
		hookAllMethods(FooterActionsControllerClass, "onViewAttached", new XC_MethodHook()
		{
			@Override
