...
public class BackToKill extends XposedModPack
{
	...
	public BackToKill(Context context)
	{
		super(context);
	}
	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam)
	{
		...
		View.OnLongClickListener listener = v -> {
			...
			Shell.cmd("am force-stop $(dumpsys window | grep mCurrentFocus | cut -d \"/\" -f1 | cut -d \" \" -f5)")
			     .submit();
			
			return true;
		};
		
		findAndHookMethod(NavBarClass, "getView", new XC_MethodHook()
		{
			@Override
