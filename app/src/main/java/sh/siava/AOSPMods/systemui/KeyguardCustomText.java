	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable
	{
		...
		hookAllConstructors(CarrierTextControllerClass, new XC_MethodHook()
		{
			...
			protected void afterHookedMethod(MethodHookParam param) throws Throwable
			{
				...
				hookAllMethods(carrierTextCallback.getClass(), "updateCarrierInfo", new XC_MethodHook()
				{
					@Override
		...
		hookAllMethods(KeyguardClockSwitchClass, "onFinishInflate", new XC_MethodHook()
		{
			...
			protected void afterHookedMethod(MethodHookParam param) throws Throwable
			{
				try {
					...
					int padding = res.getDimensionPixelSize(res.getIdentifier("clock_padding_start", "dimen", mContext.getPackageName()));
