...
public class QSQuickPullDown extends XposedModPack
{
	...
	public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable
	{
		...
		findAndHookMethod(NotificationPanelViewControllerClass, "isOpenQsEvent", MotionEvent.class, new XC_MethodHook()
		{
			@Override
			protected void afterHookedMethod(MethodHookParam param) throws Throwable
			{
				...
				boolean showQsOverride = (pullDownSide == PULLDOWN_SIDE_RIGHT) ? w - region < x : x < region;
